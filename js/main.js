...
Flap.prototype.hasCollision = function () {
  var flapRect = { x: flap.x, y: flap.y, width: 160 / 3, height: 37 };
  ...
  for (var i = 0; i < pipes.length; i++) {
    topPipeRect = {
      x: pipes[ i ].currentX - pipeImg.width,
      y: pipes[ i ].currentYTopPipe - pipeImg.height,
      width: pipeImg.width,
      height: pipeImg.height
    };
    bottomPipeRect = {
      x: pipes[ i ].currentX,
      y: pipes[ i ].currentYBottomPipe,
      width: pipeImg.width,
      height: pipeImg.height
    };
